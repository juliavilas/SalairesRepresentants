...
public class Representant {
    ...
    public void enregistrerCA(int mois, float montant) {
        ...
        System.out.println("Le chiffre d'afafires mensuel est de :"+ CAMensuel);
    }
    ...
    public float salaireMensuel(int mois, float pourcentage) {
        ...
        float salaire = salaireFixe + secteur.getIndemniteRepas() + pourcentage * CAMensuel[mois];
        return salaire;
    }

    @Override
    public String toString() {
        return "Representant{" + "numero=" + numero + ", nom=" + nom + ", prenom=" + prenom + ", secteur=" + secteur + '}';
    }
